          ...
          <a
            href={
              driver.driverId === 'antonelli' 
                ...
                ? 'https://www.formula1.com/en/drivers/guanyu-zhou'
                : `https://www.formula1.com/en/drivers/${driver.givenName.normalize("NFD").replace(/[\u0300-\u036f]/g, "").toLowerCase().replace(/[^a-z0-9]/g, '-')}-${driver.familyName.normalize("NFD").replace(/[\u0300-\u036f]/g, "").toLowerCase().replace(/[^a-z0-9]/g, '-')}`
            }
            target="_blank"
