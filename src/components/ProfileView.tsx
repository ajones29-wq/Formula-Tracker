...
type ProfileTab = 'profile' | 'settings' | 'drivers' | 'constructor';
    ...
    return (
      <div className="max-w-2xl mx-auto mt-8 relative">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8 sm:p-12 text-center space-y-6">
          <div className="w-16 h-16 bg-accent-600/10 rounded-full flex items-center justify-center text-accent-500 mx-auto border border-accent-500/20">
          ...
          <form onSubmit={handleSave} className="space-y-8">
            ...
            <div className="pt-4 flex items-center justify-between border-t border-zinc-800 mt-6">
              ...
              <button
                type="submit"
                disabled={saving}
                className="inline-flex items-center gap-2 bg-accent-600 text-white font-bold uppercase tracking-wider text-sm px-8 py-3 rounded-xl hover:bg-accent-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed mt-4"
              >
                {saving ? (
                  <>
